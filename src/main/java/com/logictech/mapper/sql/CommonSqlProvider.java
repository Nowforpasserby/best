 ...
 */
public class CommonSqlProvider extends MapperTemplate {
    public CommonSqlProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
        super(mapperClass, mapperHelper);
    }

    public String mInsert(MappedStatement ms) {
